...
const app = new Hono()
  .get("/", sessionMidddleware, async (c) => {
  ...
  .get("/:workspaceId", sessionMidddleware, async (c) => {
    const user = c.get("user");
    const databases = c.get("databases");
  ...
  .get("/:workspaceId/info", sessionMidddleware, async (c) => {
    const databases = c.get("databases");
    const { workspaceId } = c.req.param();
  ...
  .delete("/:workspaceId", sessionMidddleware, async (c) => {
    const databases = c.get("databases");
    const user = c.get("user");
  ...
  .post("/:workspaceId/reset-ivite-code", sessionMidddleware, async (c) => {
    const databases = c.get("databases");
    const user = c.get("user");
  ...
  .get("/:workspaceId/analytics", sessionMidddleware, async (c) => {
    const databases = c.get("databases");
    const user = c.get("user");
    const { workspaceId } = c.req.param();
